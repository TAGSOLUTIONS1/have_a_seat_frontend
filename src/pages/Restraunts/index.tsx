...
import DiningOptions from "./Filters/DiningOptions";
import Experiences from "./Filters/Experiences";
import SeatingOptions from "./Filters/SeatingOptions";
import Regions from "./Filters/Regions";
import Neighbourhood from "./Filters/NeighbourHoods";
import Cuisine from "./Filters/Cuisine";
import TopRated from "./Filters/TopRated";
import SafetyPrecautions from "./Filters/SafetyPrecautions";
import Ameneties from "./Filters/Ameneties";
...
const Search = () => {
  ...
  return (
    <div className="flex max-w-full relative w-[1300px] justify-center p-4 ">
      ...
      <strong><Sliders size={24} className="inline-block mr-2" />FILTERS</strong>
      </h1>
      <DiningOptions/>
      <Experiences/>
      <SeatingOptions/>
