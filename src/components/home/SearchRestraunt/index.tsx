...
const SearchRestaurant = () => {
  return (
    <div className="hidden sm:flex justify-center absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 w-4/5 m-auto rounded-[40px] bg-purple-600 bg-opacity-75 py-6 px-20 text-white">
