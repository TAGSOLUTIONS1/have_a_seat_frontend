  ...
  const slides = [
    {
      ...
      title: "New Cafe",
      intro: "Explore trendy new spots with fresh brews and flavors.",
      location: "Los Angles",
    ...
    },
    {
      ...
      title: "Ocean's View",
      intro: "Dine with breathtaking ocean views and great food.",
      location: "New York",
      phoneNumber: "(051)7860123",
    },
    {
      image: "/assets/download_slider_4.jpg",
      title: "Richard's Villa",
      intro: "Experience luxury dining in a charming villa setting.",
      location: "California",
      phoneNumber: "(051)7860123",
    },
    {
      ...
      title: "Bars",
      intro: "Savor crafted drinks and vibrant atmospheres at top.",
      location: "Arazona",
      phoneNumber: "(051)7860123",
    },
  ];
          ...
          <div className="flex justify-center space-x-6 sm:space-x-8">
            <div className="sm:flex sm:space-x-4">
              {[currentSlide, (currentSlide + 1) % totalSlides].map((index) => (
                <div
                  key={index}
                  className={`flex flex-col w-[320px] md:w-[360px] sm:w-[320px] lg:w-[400px] bg-white rounded-lg shadow-lg h-[430px] overflow-hidden ${
                    index === currentSlide
