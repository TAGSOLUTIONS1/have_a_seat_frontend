...
const SearchLocationV2 = memo(
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      <div className="w-full hidden lg:flex max-w-[85vw] mx-auto bg-white border-2 border-plum rounded-2xl md:rounded-[3rem] shadow-lg border border-gray-100 p-4 md:py-2 md:px-6 flex-col md:flex-row gap-4 lg:gap-2 items-stretch md:items-center">
        {/* Location */}
