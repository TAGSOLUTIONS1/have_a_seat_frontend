            ...
            <div className="w-full lg:w-1/4 mb-8 lg:mb-0">
              <div className="flex flex-col items-center lg:items-start">
                ...
                <p className="text-white text-lg mb-4 font-bold mt-4 lg:text-left">
                  Experience seamless dining reservations with the world at your
                  fingertips and Join millions of diners worldwide and reserve
            ...
            <div className="w-full lg:w-1/4">
              <div className="flex flex-col items-center lg:items-start">
                ...
                <ul className="mt-8 text-sm sm:text:md md:text-xl  text-white list-square space-y-4 text-2xl">
                  ...
                  <li className="flex items-center">
                    <span className="">
                      <img className="mr-4" src="/assets/mail.png" />
                    </span>
